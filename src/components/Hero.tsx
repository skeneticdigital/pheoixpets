    ...
    >
      ...
      <div className="container-shell h-full flex flex-col justify-center items-center relative z-10 px-6 sm:px-10 lg:px-12 mt-12">
        <div ref={heroContentRef} className="max-w-4xl flex flex-col items-center text-center">
          <p className="text-[#ff7a00] font-bold tracking-[0.4em] uppercase text-sm md:text-base mb-6 drop-shadow-md bg-black/40 px-10 py-3 rounded-full border border-white/50 backdrop-blur-md inline-block shadow-lg">
            {heroContent.eyebrow}
          </p>
