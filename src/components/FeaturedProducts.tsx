            ...
            >
              ...
              <div className="mt-4 flex items-center justify-between border-t border-charcoal/5 pt-4">
                ...
                <button 
                  ...
                  className="flex h-10 w-10 items-center justify-center rounded-full bg-cream-soft text-charcoal transition-colors group-hover:bg-[#ff7a00] group-hover:text-white"
                >
                  <ShoppingBag size={18} />
                </button>
              </div>
